...
import "./interfaces/ILockPublicERC721Test.sol";
 ...
 */
contract PublicLockERC721Test is ILockPublicERC721Test {
  ...
  */
    ...
    notSoldOut()
  {
    ...
    IUnlockERC721Test unlock = IUnlockERC721Test(unlockProtocol);
    uint discount;
    uint tokens;
