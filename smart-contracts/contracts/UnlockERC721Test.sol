...
import "./PublicLockERC721Test.sol";
import "./interfaces/IUnlockERC721Test.sol";


contract UnlockERC721Test is IUnlockERC721Test, Ownable, Initializable {
  ...
  */
  function createLock(
    ...
    public
    returns (ILockCoreERC721Test lock)
  {

    // create lock
    PublicLockERC721Test newPublicLock = new PublicLockERC721Test(
      msg.sender,
      _expirationDuration,
      _keyPrice,
      _maxNumberOfKeys
