  ...
  describe('notifyNewKeyToWedlocks', () => {
    it('should notify wedlocks if there is an email metadata', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith('http://localhost:1337', {
        body: '{"template":"keyMined-0xlock","failoverTemplate":"keyMined","recipient":"julien@unlock-protocol.com","params":{"keychainUrl":"https://app.unlock-protocol.com/keychain"},"attachments":[]}',
