...
export const routes: Routes = {
  ...
  state: {
    ...
    seo: customizeSEO({
      ...
      description: 'The state of the Unlock Protocol network, with total locks deployed, active locks and total keys minted. It displays data across all support blockchains.',
    }),
  },
}
