...
const ConnectLegacyModalContext = createContext({
...
export const ConnectModalProvider = (props: Props) => {
  ...
  return (
    <ConnectLegacyModalContext.Provider
      value={{
        open,
        status,
        closeConnectModal,
...
export const useLegacyConnectModal = () => {
  return useContext(ConnectLegacyModalContext)
}
