...
if (lockedNode) {
  var src = UNLOCK_URL || 'http://localhost:3000'
  ...
  s.setAttribute(
    'style',
    'display:none; position:fixed; top:30%; left:30%; width:50%; height:50%; border:0px; background: transparent; z-index: 2147483647;'
  )
