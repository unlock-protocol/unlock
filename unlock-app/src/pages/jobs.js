...
export const Jobs = () => (
  <Layout forContent>
    <Head>
      ...
      <OpenGraphTags title={pageTitle('Work at Unlock')} description={'We\'re looking for world-class engineers who want to fix the Web forever.'} canonicalPath='/jobs' />
    </Head>
    <Section>
      ...
      <Headline>We want to provide an environment where you can do your best work. This includes (but is not limited to):</Headline>
      <ShortColumn>
...
is its lack of business model? Do you think that individuals, democracies and the web, deserve better than click-bait, information overload and fake news?
        ...
        <UnorderedList>
          ...
          <ListItem>Implement services to normalize and store data pulled from our smart contracts</ListItem>
          <ListItem>Build both client-side and server-side APIs which will be used to communicate data between our servers on our front end applications</ListItem>
        </UnorderedList>
        ...
        <UnorderedList>
          ...
          <ListItem>Great communication skills to ensure efficient collaboration with other team members and our community</ListItem>
...
is its lack of business model? Do you think that individuals, democracies and the web, deserve better than click-bait, information overload and fake news?
        ...
        <UnorderedList>
          <ListItem>Tools for creators: You will be in charge of building a comprehensive yet simple interface to empower creators to create the locks they need and embed them in their own sites or platforms.</ListItem>
          <ListItem>Checkout UX: Unlock will provide the best paywall you’ve ever used. It needs to be smooth and elegant.</ListItem>
          <ListItem>Front-end architecture: Both of the goals above will be served by a robust and maintainable architecture. Your job includes making informed decisions based on these goals as well as implementing a technical foundation that will enable rapid iteration.</ListItem>
        </UnorderedList>
        ...
        <UnorderedList>
          ...
          <ListItem>You ship high quality, well tested and documented code to meet the needs of users, customers, and colleagues</ListItem>
          <ListItem>High degree of autonomy and extensive communication skills to ensure that efficient collaboration with other team members and our community</ListItem>
          <ListItem>Be a steward and influencer of our early engineering culture</ListItem>
          <ListItem>In NYC or willing to relocate</ListItem>
        </UnorderedList>
