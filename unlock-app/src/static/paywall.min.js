!(function(e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(t)
      : (((e = e || self).paywall = e.paywall || {}),
      (e.paywall.min = e.paywall.min || {}),
      (e.paywall.min.js = t()))
})(this, function() {
  'use strict'
  var c = [
  ...
  function t(e, t, n) {
    ...
    if (
      (a ||
        (a = (function(e) {
          for (
            ...
            if (n.test(r)) {
              var i = t[a].getAttribute('data-unlock-url')
              return i || r.substring(0, r.indexOf('/static/paywall'))
            }
          }
          return s
        })(t)),
      ...
      var r,
        i,
        o = ((r = a += '/paywall/'.concat(n, '/')),
        (i = t.createElement('iframe')).setAttribute('style', c.join('; ')),
        i.setAttribute('src', r),
        i.setAttribute('data-unlock', 'yes'),
        i)
      if (o) {
        var l, d
        ;(d = o),
        ...
        e.addEventListener(
          ...
          function(e) {
            ...
            'unlocked' === e.data &&
                ((u = !1),
                ((n = o).style.backgroundColor = 'transparent'),
        ...
        function(l, e) {
          e.forEach(function(e) {
            if (e.addedNodes.length && e.addedNodes.length) {
              ...
              try {
                for (
                  var r, i = e.addedNodes.entries()[Symbol.iterator]();
                  !(t = (r = i.next()).done);
                  t = !0
                ) {
                  var o = r.value[1]
                  'META' === o.nodeName && 'lock' === o.name && l(o.content)
                }
              } catch (e) {
                ;(n = !0), (a = e)
              } finally {
