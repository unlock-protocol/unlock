  ...
  v7: {
    PublicLock: {
      ...
      abi: [
        ...
        'function updateTransferFee(uint256 _transferFeeBasisPoints)',
        'function withdraw(address _tokenAddress,uint256 _amount)',
        'function initialize(address _lockOwner,uint256 _expirationDuration,address _tokenAddress,uint256 _keyPrice,uint256 _maxNumberOfKeys,string _lockName)',
        'function initialize()',
        'function initialize(address sender)',
      ],
      bytecodeHash:
        '0xaf77d0f03e55614852974803f729d31c92c1db013fe6ea0269c9700e6f1ecb66',
    },
    Unlock: {
      contractName: 'Unlock',
      abi: [
      ...
      bytecodeHash:
        '0x3e8ed09490876be9c227005a07054f713db8902233b18d3e9df5c93ca916370c',
    },
  },
}
