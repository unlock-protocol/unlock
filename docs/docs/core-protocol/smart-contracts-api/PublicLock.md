...
```solidity
function purchase(struct PublicLock (v15).PurchaseArgs[] purchaseArgs) external payable returns (uint256[] tokenIds)
```
...
| Name         | Type                                   | Description          |
| ------------ | -------------------------------------- | -------------------- |
| purchaseArgs | struct PublicLock (v15).PurchaseArgs[] | array of PurchaseArg |
