      ...
      <div className="mb-8">
        <div className="bg-white bg-opacity-80 rounded-2xl p-6">
          ...
          <div className="text-left text-sm">
            ...
            <dl>
              <dt className="font-bold pt-4">Membership</dt>
              <dd className="mx-5">
                A connection between a creator, brand or project and a fan or
                community member. A membership usually confers benefits or
                special access to those who hold it. Members can also connect
                directly with each other.
              </dd>
              <dt className="font-bold pt-4">Lock</dt>
              <dd className="mx-5">
              ...
              <dt className="font-bold pt-4">Key</dt>
              <dd className="mx-5">
              ...
              <dt className="font-bold pt-4">Dashboard</dt>
              <dd className="mx-5">
          ...
          <div className="mt-4">
            <a href="/getting-started/glossary" className="block w-full">
              <Button className="w-full">See Full Glossary</Button>
            </a>
          </div>
        </div>
      </div>
    ...
    <div className="w-full md:w-1/2 px-4">
      <div className="mb-8">
        <div className="bg-white bg-opacity-80 rounded-2xl p-6">
          ...
          <div className="text-left text-sm">
            <dl>
              <dt className="font-bold pt-4">Overview of Unlock Protocol</dt>
              <dd>
              ...
              <dt className="font-bold pt-4">The Unlock Ecosystem</dt>
              <dd>
              ...
              <dt className="font-bold pt-4">Front-end live coding tutorial</dt>
              <dd>
              ...
              <dt className="font-bold pt-4">Back-end live coding tutorial</dt>
              <dd>
          ...
          <div style={{ marginTop: '0.5rem' }}>
            <a
              href="https://www.youtube.com/unlockprotocol"
              className="block w-full"
            >
              <Button className="w-full">See All Video Tutorials</Button>
            </a>
          </div>
        </div>
      </div>
