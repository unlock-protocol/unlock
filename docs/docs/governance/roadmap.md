...
- The [Unlock Protocol Tokens](/governance/unlock-dao-tokens), aka UP, governance tokens for the Unlock ecosystem, are used to share ownership, as well as incentivize the use of the protocol.
