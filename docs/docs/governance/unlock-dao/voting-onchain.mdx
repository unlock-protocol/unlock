...
However, in some instances (for example, if a front-end like Tally is unavailable), voting can be done by interacting directly with the contracts via Etherscan. Here are the 5 steps to vote by using the Etherscan UI:
