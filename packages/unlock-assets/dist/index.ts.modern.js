...
var SvgCoinbaseWallet = function SvgCoinbaseWallet(_ref) {
  ...
  return /*#__PURE__*/createElement("svg", _extends({
    ...
    fill: "#2059EB"
  }), /*#__PURE__*/createElement("defs", null, /*#__PURE__*/createElement("linearGradient", {
...
var SvgLiveDemo = function SvgLiveDemo(_ref) {
  ...
  return /*#__PURE__*/createElement("svg", _extends({
    ...
    id: titleId
  }, title) : null, /*#__PURE__*/createElement("mask", {
    id: "live-demo_svg__a",
    fill: "#fff"
  }, /*#__PURE__*/createElement("path", {
    fillRule: "evenodd",
...
var SvgLoading = function SvgLoading(_ref) {
  ...
  return /*#__PURE__*/createElement("svg", _extends({
    ...
    id: titleId
  }, title) : null, /*#__PURE__*/createElement("circle", {
    cx: 16,
    cy: 3,
    r: 0
...
var SvgUnlockWordMark = function SvgUnlockWordMark(_ref) {
  ...
  return /*#__PURE__*/createElement("svg", _extends({
    ...
    d: "M12.523 4.379v1.27H.204v-1.27h12.319ZM9.03 0h2.136v7.723c0 .846-.199 1.591-.597 2.234A4.083 4.083 0 0 1 8.9 11.463c-.716.358-1.553.537-2.51.537-.957 0-1.793-.179-2.51-.537a4.082 4.082 0 0 1-1.67-1.506c-.395-.643-.592-1.388-.592-2.234V0h2.13v7.544c0 .493.108.931.322 1.316.218.385.525.687.919.906.398.216.865.323 1.401.323.54 0 1.007-.107 1.402-.323.398-.22.704-.521.918-.906.215-.385.322-.823.322-1.316V0ZM15.929 6.626v5.195H13.85V2.955h1.987v1.507h.104a2.53 2.53 0 0 1 .97-1.183c.448-.293 1.001-.44 1.66-.44.608 0 1.139.132 1.59.393.456.262.808.641 1.057 1.137.253.497.377 1.099.374 1.807v5.645h-2.08V6.5c0-.592-.152-1.056-.459-1.39-.302-.336-.722-.503-1.258-.503-.363 0-.687.08-.97.242-.28.158-.5.387-.66.687-.157.3-.236.664-.236 1.091ZM25.615 0v11.821h-2.079V0h2.079ZM31.432 11.994c-.862 0-1.608-.19-2.24-.571a3.873 3.873 0 0 1-1.47-1.599c-.345-.685-.517-1.485-.517-2.401 0-.916.172-1.718.517-2.407a3.865 3.865 0 0 1 1.47-1.605c.632-.38 1.378-.571 2.24-.571.861 0 1.608.19 2.24.571.631.381 1.12.916 1.464 1.605.348.689.522 1.491.522 2.407 0 .916-.174 1.716-.522 2.401a3.835 3.835 0 0 1-1.465 1.599c-.631.38-1.378.571-2.24.571Zm.011-1.674c.467 0 .858-.129 1.172-.386.314-.262.547-.612.7-1.05.157-.44.236-.928.236-1.467 0-.543-.079-1.033-.236-1.472-.153-.442-.386-.794-.7-1.056-.314-.262-.705-.393-1.172-.393-.479 0-.877.131-1.195.393-.313.262-.549.614-.706 1.056-.153.439-.23.93-.23 1.472 0 .539.077 1.027.23 1.466.157.439.393.789.706 1.05.318.258.716.387 1.195.387ZM41.102 11.994c-.88 0-1.637-.194-2.269-.583a3.887 3.887 0 0 1-1.453-1.61c-.337-.689-.505-1.482-.505-2.378 0-.9.172-1.695.517-2.384a3.87 3.87 0 0 1 1.458-1.616c.632-.389 1.379-.583 2.24-.583.716 0 1.35.133 1.901.398.555.262.998.633 1.327 1.114.33.477.517 1.035.563 1.674h-1.987a1.912 1.912 0 0 0-.575-1.068c-.298-.288-.698-.433-1.2-.433a1.87 1.87 0 0 0-1.12.347c-.322.227-.572.554-.752.98-.176.428-.264.94-.264 1.536 0 .604.088 1.124.264 1.559.176.43.423.763.74.998.322.231.7.346 1.132.346.306 0 .58-.057.821-.173.245-.119.45-.29.615-.513.164-.224.277-.495.339-.814h1.987a3.495 3.495 0 0 1-.552 1.668 3.27 3.27 0 0 1-1.298 1.131c-.547.27-1.19.404-1.93.404ZM48.15 9.039l-.005-2.522h.333l3.17-3.562h2.43l-3.9 4.364h-.43l-1.597 1.72Zm-1.894 2.782V0h2.079v11.821h-2.08Zm5.536 0L48.92 7.786l1.402-1.471 3.957 5.506h-2.487Z",
    fill: "#000"
  }));
};
...
var SvgUnlockMonogram = function SvgUnlockMonogram(_ref) {
  var title = _ref.title,
      titleId = _ref.titleId,
      props = _objectWithoutPropertiesLoose(_ref, _excluded$$);
...
var SvgComponents = {
  ...
  UnlockMonogram: SvgUnlockMonogram,
  Wallet: wrapViewBox(SvgWallet, '-8 -8 32 32'),
  WalletConnect: wrapViewBox(SvgWalletConnect, '0 -1 32 32'),
