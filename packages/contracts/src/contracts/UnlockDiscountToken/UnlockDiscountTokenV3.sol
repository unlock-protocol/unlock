...
// File @unlock-protocol/contracts/dist/UnlockDiscountToken/UnlockDiscountTokenV2.sol@v0.0.21

// Sources flattened with hardhat v2.8.0 https://hardhat.org
// Original license: SPDX_License_Identifier: MIT

// File contracts/ERC20Patched.sol
  ...
  ERC20VotesCompUpgradeable
{
  ...
  function initialize2() public {
    require(
      _EIP712NameHash() == bytes32(0),
      "Already initialized: EIP712_init, ERC20Permit_init, ERC20Votes_init"
    );
  ...
  function name()
    public
    view
    override(IERC20MetadataUpgradeable, ERC20DetailedUpgradeable)
  ...
  function decimals()
    public
    view
    override(ERC20Upgradeable, ERC20DetailedUpgradeable)
    returns (uint8)
  {
...
// File contracts/UnlockDiscountTokenV3.sol
