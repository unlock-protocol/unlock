...
const doNotModify = `// This file is auto-generated by ../../../scripts/compressAbi.js
...
fs.writeFileSync(
  ...
  `${doNotModify}
  const bytecode = ${JSON.stringify(deployedBytecodes, null, 2)}
...
fs.writeFileSync(
  ...
  `${doNotModify}
  const bytecode = ${JSON.stringify(bytecodes, null, 2)}
  export default bytecode
  `
)
